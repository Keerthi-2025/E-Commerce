...
public class OrdersServiceImpl implements OrdersService {
    ...
    @Override
    public String createOrders(Integer order_id, String total_amt, String user_id, List<OrderItems> orderItems) {
        User user = userRepository.findById(user_id).orElseThrow(()-> new ApiRequestException("User not found"));
        Orders orders = ordersMapper.toorders(order_id, total_amt, user_id, orderItems);
